...
import { ejbDirective, EJB_DEFAULT_PREFIX_GLOBAL, EJB_DEFAULT_PREFIX_DIRECTIVE, EJB_DEFAULT_PREFIX_VARIABLE, ESCAPE_HTML, ESPACE_HTML_REGEX, DIRECTIVE_REGEX, EJB_HEAD_DIRECTIVE_REPLACER, EjbAst } from "../src/constants";
